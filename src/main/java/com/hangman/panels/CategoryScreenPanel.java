...
import com.hangman.buttons.CategoryButton;
...
public class CategoryScreenPanel extends JPanel implements ActionListener {
    ...
    final String[] categoryButtonsText = { "Random" };
    private CategoryButton[] categoryButtons = new CategoryButton[3];
    private BackButton backButton;
    private MainGamePanel mainGamePanel;
    private Words words;

    public CategoryScreenPanel(int WIDTH, int HEIGHT, ImageIcon backgroundImg, JPanel container, CardLayout cardLayout,
